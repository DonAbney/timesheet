...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://jee1vvadic.execute-api.us-east-1.amazonaws.com/mock';
    ...
    apigClient.indexHtmlGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var indexHtmlGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/index.html').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(indexHtmlGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.timesheetMinCssGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var timesheetMinCssGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/timesheet.min.css').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(timesheetMinCssGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.timesheetMinJsGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var timesheetMinJsGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/timesheet.min.js').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(timesheetMinJsGetRequest, authType, additionalParams, config.apiKey);
    };
